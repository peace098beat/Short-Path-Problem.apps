...
class Agent(object):
    ...
    def learn(self, o, a, r, o_next):
        ...
        self.learningObj.fit(np.asarray(self.X), np.asarray(self.Y), learning_rate=0.2, epochs=500)
...
class GameWindow(QWidget):
    ...
    def mainloop(self):
        ...
        # 3. Agentに学習させる
        # -----------------------------
        self.agent.learn(np.copy(o), a, r, np.copy(o_next))
...
class GameMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # シミュレーション描画ウィンドウ(右上)
        self.widget1 = GameWindow(self.centralwidget, nrow=10, ncol=10)
        self.widget1.setGeometry(QRect(300, 0, 300, 300))
        self.widget1.setFixedSize(300, 300)

        # シミュレーション描画ウィンドウ(左下)
        self.widget2 = GameWindow(self.centralwidget, ncol=7, nrow=7)
        self.widget2.setGeometry(QRect(0, 300, 300, 300))
        self.widget2.setFixedSize(300, 300)

        # シミュレーション描画ウィンドウ(右下)
        self.widget3 = GameWindow(self.centralwidget, ncol=15, nrow=15)
